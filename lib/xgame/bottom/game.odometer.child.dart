...
import 'package:tournament_client/xgame/bottom/widget/image.box.delay.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        && widget.machineNumber != 0
            ?
            DelayedJpDropBox(
                isDrop: true,
                borderRadius: MyString.padding16,
                jpName: "VEGAS JP",
                jpNameSpace: "VEGAS\nJP",
                width: SizeConfig.jackpotWithItem,
                height: widget.height * SizeConfig.jackpotHeightRation,
                asset: "asset/eclip.png",
                delay: const Duration(seconds: MyString.JPShowDelayTime), // Delay of 10 seconds
                title: "CONGRATULATIONS\nYOU WIN",
                textSize: MyString.padding46,
                lastestValue: widget.endValue1,
                ...
                widget: Row(
                  ...
                  children: [
                    ...
                    SlideOdometerTransition(
                      verticalOffset: -MyString.padding26,
                      groupSeparator: const Text('.',style: TextStyle(
                        fontSize: MyString.padding46,
                        color: MyColor.yellow_bg,
                        fontWeight: FontWeight.bold,
                      ),),
                      letterWidth: MyString.padding26,
